...
export class HomeMozoComponent implements OnInit {
  ...
  ngOnInit() {
    this.db
      ...
      .doc("mozoConsulta")
      .snapshotChanges()
      .subscribe((data) => this.activarNotificacionConsulta());
    this.db
      .collection("notificaciones")
      .doc("mozoComida")
      .snapshotChanges()
      .subscribe((data) => this.activarNotificacionComida());
    this.db
      .collection("notificaciones")
      .doc("mozoBebida")
      .snapshotChanges()
      .subscribe((data) => this.activarNotificacionBebida());
    this.db
      .collection("notificaciones")
      .doc("mozoComidaNueva")
      .snapshotChanges()
      .subscribe((data) => this.activarNotificacionComidaNueva());
  }
